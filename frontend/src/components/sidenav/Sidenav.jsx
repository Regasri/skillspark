  ...
  return (
    <div className='sidenav-main-container'>
      <div className='sidenav-profile-container'>
        ...
        <p className='sidenav-profile-name'>Nullify</p>
        <p className='sidenav-profile-email'>Nullify@gmail.com</p>
      </div>
      <div className='sidenav-list-main-container'>
        ...
        <Link to="/admin/skills"><div className={`sidenav-list ${location.pathname === "/admin/skills" ? "default-hover" : ""}`}><span><FaPeopleGroup className='sidenav-icon' /></span><p className='sidenav-list-text'>My Skills</p></div></Link>
        ...
        <Link to="/admin/achievements"><div className={`sidenav-list ${location.pathname === "/admin/achievements" ? "default-hover" : ""}`}><span><IoIosTime className='sidenav-icon' /></span><p className='sidenav-list-text'>My Achievements</p></div></Link>
